...
export default class ApiService {
    ...
    static const BASE_URL = process.env.REACT_APP_API_URL;
    ...
    static async registerUser(user) {
        const response = await axios.post(
            `${this.BASE_URL}/auth/register`,user)
    ...
    static async deleteRoom(roomId) {
        const result = await axios.delete(`${this.BASE_URL}/rooms/delete-room/${roomId}`, {
            headers: this.getHeaders()
        })
        return result.data
    }
    ...
    static async updateRoom(roomId, formData) {
        const result = await axios.put(`${this.BASE_URL}/rooms/update-room/${roomId}`, formData, {
            headers: {
                ...this.getHeaders(),
                'Content-Type': 'multipart/form-data'
            }
